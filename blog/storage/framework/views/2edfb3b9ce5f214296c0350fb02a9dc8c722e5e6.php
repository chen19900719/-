    ...
    <div id="content" class="content">
        <div id="innerContent">
            ...
            <div class="textbox-title">
                <h4>
                    <img src="/assets/Images/icon_ctb.gif" width="11" height="11" border="0" align="absmiddle">
                    <?php echo e($article->content); ?>

                </h4>
                <div class="textbox-label">
                    [<span style="color:gray;font-weight:normal">2015-9-16 15:33:33 发表在 <a
                                href="#"><?php echo e($article->category->name); ?></span> ]
                </div>
            </div>
            ...
            <div class="textbox-bottom"><img src="/assets/images/cm_t_ArtRank2.gif" width="12" height="12" border="0"
                                             align=""> <a href="#reply">我有话要说</a></div>
            <div class="textbox-urls" align="right"></div>
            <div class="no-comment-box"> [ 管理：<a href="__URL__/edit/id/{$vo.id}" target="_blank">编辑日志</a> <a href="#">删除日志</a>
                ]
            </div>
            <div id="comments">
                <?php $__currentLoopData = $article->comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                    <div class="commentbox">
                        <a></a>
                        <div class="commentbox-title"><a><?php echo e($c->username); ?></a> 发表的评论 <span
                                    style="color:gray">[ 2014-9-11 15:20:20 ]</span>
                            <a href="">删除评论</a></div>
                        <div class="commentbox-content"><?php echo e($c->content); ?></div>
                    </div>
                ...
                <form method="post" id="form1">
                    <table cellpadding=3 cellspacing=3 width="450px">
                        ...
                        <tr>
                            <td class="tRight tTop"></td>
                            <td class="tLeft">
                                <html:editor type="ubb" id="editor" width="450px" height="185px"
                                             name="content"></html:editor>
                            </td>
                        </tr>
                        <tr>
                            <td></td>
