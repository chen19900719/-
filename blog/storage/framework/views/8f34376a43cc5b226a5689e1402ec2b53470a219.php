        ...
        <div id="innerContent">
            <div class="commentbox">
                <TABLE cellpadding=3 cellspacing=3 width="680px">
                    ...
                    <TR>
                        <TD colspan="2">
                            <form METHOD=POST id="form1"  action="/article/<?php echo e($article->id); ?>">
                                ...
                                <TABLE cellpadding=3 cellspacing=3 width="100%" style="font-size:14px">
                                    ...
                                    <TR>
                                        ...
                                        <TD class="tLeft"><input TYPE="text" class="huge text" check='Require' warning="标题不能为空" NAME="title" value="<?php echo e($article->title); ?>"></TD>
                                    </TR>
                                    <TR>
                                        ...
                                        <TD class="tLeft" >
                                            ...
                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                <option value="<?php echo e($c->id); ?>" <?php if($article->category_id==$c->id): ?> selected <?php endif; ?>>
                                                    <?php echo e($c->name); ?>
                                    ...
                                    <TR>
                                        ...
                                        <TD class="tLeft"><textarea name="content" id="textContent" cols="45" rows="5"><?php echo e($article->content); ?></textarea></TD>
                                    </TR>
