    ...
    <div id="innerHeader">
        ...
        <div class="blog-header">
            <div class="blog-title">
                <IMG SRC="/assets/images/logo.png" style="border:1px solid gray" BORDER="0" ALT="" align="absmiddle"> <a
                        href="http://www.whphp.com">WHPHP</a>
            </div>
        ...
        <div id="innerContent">
            ...
            <div class="commentbox">
                <table cellpadding=3 cellspacing=3 width="680px">
                    <tr>
                        <td colspan="2">
                            <div class="block-title"><H5><IMG SRC="/assets/images/modify.gif" WIDTH="20" HEIGHT="23"
                                                              BORDER="0" ALT="" align="absmiddle"> 发表新的日志</H5></div>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <form METHOD=POST id="form1" action="/article">
                                ...
                                <table cellpadding=3 cellspacing=3 style="font-size:14px">
                                    ...
                                    <tr>
                                        ...
                                        <td class="tLeft"><input TYPE="text" class="huge text" check='Require'
                                                                 warning="标题不能为空" NAME="title"></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tLeft"><textarea name="content" id="textContent" cols="45"
                                                                    rows="5"></textarea></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="center">
                                            <div style="width:85%;color:gray">
                                                <div class="fLeft hMargin"><input TYPE="reset" class="submit small"
                                                                                  value="重 置"></div>
