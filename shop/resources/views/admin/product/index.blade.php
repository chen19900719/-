                        ...
                        <div class="am-u-sm-12 am-u-md-6">
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                    <a href="{{route('products.create')}}" class="am-btn am-btn-default"><span
                        ...
                        <div class="am-u-sm-12 am-u-md-12">
                            <form class="am-form-inline" role="form" method="get">
                                ...
                                <div class="am-form-group">
                                    <input type="text" name="name" class="am-form-field am-input-sm" placeholder="商品名称"
                                ...
                                <div class="am-form-group">
                                    <select data-am-selected="{btnSize: 'sm'}" name="is_onsale" id="">
                                        <option value="-1" @if(Request::input('is_onsale') == '-1') selected @endif>
                                            上架状态
                                        </option>
                                        <option value="1" @if(Request::input('is_onsale') == '1') selected @endif>上架
                                        </option>
                                        <option value="0" @if(Request::input('is_onsale') == '0') selected @endif>下架
                                        </option>
                                    </select>
                                </div>
                                    ...
                                    @foreach($products as $product)
                                        <tr data-id="{{$product->id}}">
                                            ...
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <a href="{{route('products.edit',$product->id)}}" class="am-btn
    ...
    <script>
        $(function () {
            ...
            $('#destroy_checked').click(function () {
                ...
                $.ajax({
                    type: 'DELETE',
                    url: "{{route('products.destroy_checked')}}",
                    data: checked_id,
                    success: function () {
                        alert('商品已放入回收站'); location.href=location.href;
                    }
                });
            });
            //全选
