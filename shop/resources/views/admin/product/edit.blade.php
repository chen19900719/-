...
@section('content')
    <div class="admin-content">
        ...
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">修改商品信息</strong> /
        ...
        <div class="am-g">
            <div class="am-u-sm-12 am-u-md-12">
                ...
                <form class="am-form" action="{{route('products.update',$product->id)}}" method="post">
                    {!! csrf_field() !!}
                    {!! method_field('put') !!}
    ...
    <script>
        $(function () {
            ...
            $('.cancel').click(function () {
                ...
                $.ajax({
                    type: 'delete',
                    url: "{{route('products.destroy_gallery')}}",
