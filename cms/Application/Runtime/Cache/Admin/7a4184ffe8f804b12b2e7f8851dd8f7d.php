                            ...
                            <div class="panel-body">
                                <form action="" method="post" id="form">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                        <?php if(is_array($articles)): $i = 0; $__LIST__ = $articles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$article): $mod = ($i % 2 );++$i;?><tr data-id="<?php echo ($article["id"]); ?>">
                                                <td>
                                                    <input type="hidden" name="id[]" value="<?php echo ($article["id"]); ?>">
                                                    <input type="text" value="<?php echo ($article["sort_order"]); ?>" name="sort_order[]">
                                                </td>
                                            ...
                                            <?php if(is_array($article["children"])): $i = 0; $__LIST__ = $article["children"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c): $mod = ($i % 2 );++$i;?><tr data-id="<?php echo ($c["id"]); ?>">
                                                    <td>
