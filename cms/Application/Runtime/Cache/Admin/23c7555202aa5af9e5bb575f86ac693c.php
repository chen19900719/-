                                    ...
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane fade in active" id="home">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="pinyin" class="form-control" id="pinyin"
                                                           placeholder="栏目名称">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <label class="radio-inline">
                                                        <input type="radio" name="type" id="inlineRadio1" value="1" checked> 封面
                                                    </label>
                                                    <label class="radio-inline">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <label class="radio-inline">
                                                        <input type="radio" name="is_show" id="is_show" value="1" checked> 显示
                                                    </label>
                                                    <label class="radio-inline">
